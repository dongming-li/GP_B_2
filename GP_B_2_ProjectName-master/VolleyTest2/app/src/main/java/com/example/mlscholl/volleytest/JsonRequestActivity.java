...
public class JsonRequestActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnJsonObj = (Button) findViewById(R.id.json_object_request);
        btnJsonArray = (Button) findViewById(R.id.json_array_request);
        msgResponse = (TextView) findViewById(R.id.json_response);
